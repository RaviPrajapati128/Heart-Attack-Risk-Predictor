...
## 🚀 Overview
This project demonstrates how machine learning can be applied to healthcare awareness.  
The app provides a simple interface for users to explore how everyday choices and medical indicators may influence cardiovascular health.
